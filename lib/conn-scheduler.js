...
let ConnScheduler = class ConnScheduler {
    constructor(ssb, config) {
        ...
        this.weShouldConnectToThem = ([_addr, data]) => {
            ...
            const maxHops = (_c = (_b = this.config.conn) === null || _b === void 0 ? void 0 : _b.hops, (_c !== null && _c !== void 0 ? _c : 1));
    ...
    updateTheseConnections(test, opts) {
        ...
        const peersUp = query.peersInConnection().filter(test).filter((p) => {
    ...
    populateWithSeeds() {
        var _a;
        const seeds = (_a = this.config.seeds, (_a !== null && _a !== void 0 ? _a : []));
...
__decorate([
    secret_stack_decorators_1.local()
], ConnScheduler.prototype, "pin", void 0);
__decorate([
    secret_stack_decorators_1.local()
], ConnScheduler.prototype, "unpin", void 0);
__decorate([
